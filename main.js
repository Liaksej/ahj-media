...
const app_1 = __webpack_require__(890);
const Popup_1 = __webpack_require__(858);
class MediaTools {
...
const MediaTools_1 = __webpack_require__(275);
const app_1 = __webpack_require__(890);
const Popup_1 = __webpack_require__(858);
class Message {
    text;
...
const tooltipFabric_1 = __webpack_require__(830);
const app_1 = __webpack_require__(890);
class Popup {
    actualMessages = [];
    ...
    warningPopupOnCancel(popupDelete) {
        ...
        const warningPopupCancelHandler = (event) => {
            ...
            app_1.vault.splice(-1, 1);
            document.querySelector(".audio").innerHTML = `<i class="fa-solid fa-microphone"></i>`;
            document.querySelector(".video").innerHTML = `<i class="fa-solid fa-video"></i>`;
            this.warningPopup();
...
const Message_1 = __webpack_require__(236);
exports.vault = [];
...
(() => {
/* harmony import */ var _ts_app_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(890);
